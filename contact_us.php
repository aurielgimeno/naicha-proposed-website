	...
	<div class="pageWrapper">
		...
		<div class="content">
			<div class="container lightShadow">	
				...
				<!--LOGO-->
				<div><a href="index.php"><img src="style_images/logo.png"  alt="logo.png"   class="logo"/></a></div><!--/Logo End-->
				<!--/LOGO-->
		...
		<div class="contentBorderBottom"><div class="contentBorderBottomBg"></div><!--/contentBorderBottomBg--></div><!--/contentBorderBottom-->
		...
		<!--	<div class="subContentBorderTop"></div><!--/subContentBorderTop-->
			...
			<!-- pageContainer START -->
				...
				<div class="container contactUs" style="text-align:center;" >
					<br/>
					<h1 style="color:#0c2055;">Thank you for your interest in our products and services .</h1>
					<div class="contactUsDiv brownBG">
					<h3>For any concerns, franchise inquiry, and reservations you may reach us through the following:</h3>
					<br/>
					<strong>Call us:</strong> 	
						...
						</br><strong>Visit us:</strong> 	
							<ul>
								<li>Unit 608 Culmat Bldg. E Rodriguez Ave., New Manila, 
								Quezon City (Manila Office).</li>
								<li>Unit M6 Aguinaldo St.Central Business DistrictSubic Bay Freeport Zone</li>
							</ul>
					</div>
					<!-- EMAIL  START-->
					<div class="contactUsDiv brownBG">
					<h3 >Send us an email:</h3>
						<form action="send_email.php" method="post">
							<div class="" style="margin-right:80px;margin-top:20px;">
							<label for="">Name: *</label><input type="text" name="sender_name"placeholder="Name" required/></br>
							<label for="">Email: *</label><input type="email" name="sender_email" placeholder="yourEmail@example.com" required/></br>
							<label for="">Contact #:</label><input type="text" name="sender_contact" placeholder="+639123456789" /></br>
							<label for="">Subject:</label><input type="text" name="subject" placeholder="Subject" required /></br>
							
							<label for="">Your Message:</label></br><textarea name="sender_message" id="" cols="20" rows="6" maxlength="70" placeholder="Your Message" required></textarea></br>
							</br><input class="submit button" type="submit" name="submit" value="Send Mail" />
							</div>
						</form>
					</div><!-- EMAIL END-->
		...
		<div class="footer">
			<div class="container">
				<div class="copyRight"><p>Copyright © 2014 . All Rights Reserved.</p></div>
			</div><!-- /container -->	
		</div><!-- /footer -->
